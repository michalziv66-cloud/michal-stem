    ...
    items: [
      {
        ...
        icon: "🎧",
        url: "https://math-versatile-path-pro.base44.app",
        image: "/notebook-lm/mamad-code-thumb.jpg",
      },
      {
        title: "פתרון מערכת משוואות – שיטת הנגדת המקדמים",
        description: "הסבר על פתרון מערכת משוואות בשיטת הנגדת המקדמים.",
        icon: "🎧",
        url: "/notebook-lm/elimination-method.mp4",
        isVideo: true,
        image: "/notebook-lm/elimination-method-thumb.jpg",
      },
      {
        title: "איך לפצח את קוד הישר",
        description: "הסבר על משוואת הישר.",
        icon: "🎧",
        url: "/notebook-lm/line-equation.mp4",
        isVideo: true,
        image: "/notebook-lm/line-equation-thumb.jpg",
      },
      {
        title: "השביל הסודי – משפט פיתגורס",
        description: "הסבר על משפט פיתגורס.",
        icon: "🎧",
        url: "/notebook-lm/pythagoras-path.mp4",
        isVideo: true,
        image: "/notebook-lm/pythagoras-path-thumb.jpg",
      },
    ],
  },
];
      ...
      <Card className="card-hover overflow-hidden">
        ...
        <CardContent className="space-y-3">
          ...
          <a
            ...
            className="story-link inline-flex text-sm text-primary"
          >
            פתיחה ישירה של הסרטון
          </a>
        </CardContent>
      </Card>
    );
