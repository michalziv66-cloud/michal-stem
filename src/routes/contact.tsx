      ...
      <div className="mt-10 grid gap-10 lg:grid-cols-5">
        <div ref={ctaRef} className="scroll-reveal lg:col-span-3">
          <div className="rounded-xl border bg-card p-8 text-center space-y-5">
            ...
            <h2 className="font-display text-2xl font-bold text-primary">שלחו לי הודעה</h2>
            <p className="text-muted-foreground">
              ההודעה תיפתח אצלכם עם תוכן מוכן ל-050-901-7802 או למייל שלי, ואחזור אליכם בהקדם.
            </p>
            ...
            <p className="text-xs text-muted-foreground">
              אם הוואטסאפ חסום ברשת שלכם, השתמשו בכפתור המייל.
            </p>
          </div>
        </div>
